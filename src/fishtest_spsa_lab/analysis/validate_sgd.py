...
def micro_apply_sequence(
    ...
    *,
    ...
    x = (
        z
        if param0.beta1 == 0.0
        else reconstruct_x_prev(param0.theta, z, param0.beta1)
    )
...
def main() -> None:
    ...
    seqs_mean = [
        build_sequence(outs, "const_mean") for outs in outcomes_by_report
    ]
    seqs_real = [
        build_sequence(outs, "outcomes") for outs in outcomes_by_report
    ]
